...
TARGET_DIR_PATH = ENV['TARGET_DIR_PATH'] || '//athena/excel/Qv-YIifat/Yifat/tv current year/'
...
def ytd_params
  ...
  when '01', '02', '03', '04', '05', '06'
    ...
    yield(start_date, end_date, 'tv-01-06')
  when '07', '08', '09', '10', '11', '12'
    ...
    end_date = current_date
    yield(start_date, end_date, 'tv-07-12')
  end
end
